...
#[derive(Debug)]
pub struct ZKMintNetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ZKMintNetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ZKMintNet processing");
    
    let mut processor = ZKMintNetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ZKMintNetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ZKMintNetProcessor::new(false);
